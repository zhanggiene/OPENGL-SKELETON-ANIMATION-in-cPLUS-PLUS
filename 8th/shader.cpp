...
void Shader::setInt(const std::string &name, int value) const
    ...
    // ------------------------------------------------------------------------
void Shader::setMatrixArray(const std::string &name, int number,glm::mat4 mattrixArray[number]) const
{
    //just need to pass the first array in terms of mattrixArray[0].
    glm::mat4 MA[100];
    for (int i=0;i<100;i++)
    {
        MA[i]=mattrixArray[i];
